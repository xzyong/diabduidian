...
(function($) {
	...
	$.loading = {
		...
		start: function() {
			...
			var index = $.msg('<div class="loader-inner ball-clip-rotate"><div style="border-color:' + color + '; border-bottom-color: transparent; width: 30px; height: 30px; animation: rotate 0.45s 0s linear infinite; "></div><img style="width: 16px; height: 16px;" src="' + icon + '" /></div>', {
				time: 0,
