...
+ function (e) {
            ...
            var a = function (e) {
                ...
                , s = function (e) {
                    for (var a = 0; a < t.length; a++)
                        if (t[a].name === e) return m(t[a]);
                    return [""]
                }
                , u = function (e, a) {
                    for (var n = 0; n < t.length; n++)
                        if (t[n].name === e)
                            for (var s = 0; s < t[n].sub.length; s++)
                                if (t[n].sub[s].name === a) return m(t[n].sub[s]);
                    return [""]
                }
                , t = e.rawCitiesData
                , b = t.map(function (e) {
    ...
    }, a = e.fn.cityPicker.prototype.defaults = {
        showDistrict: !0
    }
}($);