...
function(t, e, n, i) {
	...
	t.toast = function(t, a, r) {
		...
		"cancel" == a ? (o = "weui-toast_cancel", s = "weui-icon-cancel") : "forbidden" == a ? (o = "weui-toast--forbidden", s = "weui-icon-warn") : "text" == a && (o = "weui-toast--text"), e('<i class="' + s + ' weui-icon_toast"></i><p class="weui-toast_content">' + (t || "已经完成") + "</p>", o), setTimeout(function() {
			n(r)
		}, i.duration)
			...
			return u.animating = !1, u.addValue = function(t) {
				...
				function e(e) {
					if(!s && !o) {
						o = !0;
						var n = t.getTouchPosition(e);
						c = d = n.x, l = d = n.y, f = (new Date).getTime(), T = 0, C = !0, x = void 0, v = g = u.monthsTranslate
					}
				}
				...
				function i(e) {
					if(o) {
						...
						C = !1, s || (s = !0, w = u.wrapper[0].offsetWidth, y = u.wrapper[0].offsetHeight, u.wrapper.transition(0)), e.preventDefault(), k = u.isH ? p - c : d - l, T = k / (u.isH ? w : y), g = 100 * (u.monthsTranslate * h + T), u.wrapper.transform("translate3d(" + (u.isH ? g : 0) + "%, " + (u.isH ? 0 : g) + "%, 0)")
					}
				}
				...
				var o, s, c, l, p, d, f, m, v, g, w, y, T, k, x, C = !0;
