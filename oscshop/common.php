...
function clear_cache() {  
    ...
    $dirtool->del(ROOT_PATH.'runtime/cache/');  
}
 ...
 * @param number $type 1为纯数字;2为数字及字线不区分大小写;默认为空，数字及字符串区分大小写
 * @return string
 */
...
function create_random_str($length,$type=''){
	$result = '';
