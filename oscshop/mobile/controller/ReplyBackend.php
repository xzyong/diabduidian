...
class ReplyBackend extends AdminBase{
	...
	function text_add(){
		...
		if(request()->isPost()){			
			...
			if($rid){
				...
				User::get_logined_user()->storage_user_action('新增文字回复');
	...
	function text_edit(){
		...
		if(request()->isPost()){			
			...
			if($r){
				...
				User::get_logined_user()->storage_user_action('编辑文字回复');
	...
	function text_del(){
		...
		User::get_logined_user()->storage_user_action('删除文字回复');
	...
	function news_add(){
		...
		if(request()->isPost()){			
			...
			if($rid){
				...
				User::get_logined_user()->storage_user_action('新增图文回复');
	...
	function news_edit(){
		...
		if(request()->isPost()){			
			...
			if($r){
				...
				User::get_logined_user()->storage_user_action('编辑图文回复');
	...
	function news_del(){
		...
		User::get_logined_user()->storage_user_action('删除图文回复');
