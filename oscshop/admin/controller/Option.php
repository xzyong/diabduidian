...
use think\Db;
use osc\admin\model\Option as OptionModel;
...
class Option extends AdminBase{
    ...
    public function index(){
	 ...
	 public	function add(){
		...
		if(request()->isPost()){
			...
			if($return){
				User::get_logined_user()->storage_user_action('新增了选项');
	 ...
	 public	function edit(){
	 	if(request()->isPost()){
			...
			if($return){
				User::get_logined_user()->storage_user_action('修改了选项');
	...
	public function del(){
		...
		User::get_logined_user()->storage_user_action('删除了选项');
