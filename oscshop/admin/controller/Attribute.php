...
use think\Db;
use osc\admin\model\Attribute as AttributeModel;
...
class Attribute extends AdminBase{
    ...
    public function index(){			
	 ...
	 public	function add(){
		...
		if(request()->isPost()){
			...
			if($return){								
				User::get_logined_user()->storage_user_action('新增了属性');
	 ...
	 public	function edit(){
	 	if(request()->isPost()){
			...
			if($return){
				User::get_logined_user()->storage_user_action('修改了属性');
	...
	public function del(){
		...
		User::get_logined_user()->storage_user_action('删除了属性');
